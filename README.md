...
The repo now also includes an exploratory track for the Pioneer DJM-S11 scratch mixer, with a separate feasibility pass for Mixxx DJ controller mapping and Serato control-vinyl DVS usage.
